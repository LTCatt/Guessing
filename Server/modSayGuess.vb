...
#Region "题目"
    ...
    Public Sub SGLoad()
        ...
        SGData.Add("食品", RandomChaos({"三明治", "爆米花", "棉花糖", "烤红薯", "水煮鱼", "柠檬茶", "番茄酱", "茶叶蛋", "无花果", "方便面", "蛋炒饭", "矿泉水", "葡萄干", "干拌面", "薄荷糖", "猕猴桃", "葡萄酒", "八宝粥", "千层肚", "火龙果", "青苹果", "冰激凌", "小龙虾", "金针菇", "哈密瓜", "饼干", "香肠", "果醋", "豆浆", "菠萝", "鸭肠", "肥肠", "腰果", "冰糖", "红糖", "南瓜", "辣椒", "酸奶", "菠菜", "小米", "海带", "腰果", "牛排", "紫薯", "咸鱼", "豌豆", "玉米", "奶酪", "咖啡", "木耳", "黄瓜", "桑葚", "甘蔗", "茄子", "榴莲", "血旺", "柚子", "椰子", "雪碧", "山楂", "柠檬", "白酒", "蛋糕", "麻花", "糯米", "馒头", "披萨", "烧饼", "瓜子", "油条", "牛奶", "可乐"}))
